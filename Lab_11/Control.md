...
1. Cеть Operations  не может отправлять ICMP эхозапросы в сеть Sales. Разрешены эхо-запросы ICMP к другим адресатам.

*Реализация:*

1. Применим стандартный список ACL основанные только на исходном IPv4-адрес.
2. Список применем на порт R1 порт на входящий трафик запрещающий тсылку траффика в адрес сети 10.40.0.0 .Также пропишем разрешение на трафик в другие адреса сети
