...
Проверьте PING связяь между всеми устройствами в таблице IP-адресации. В случае сбоя проверки связи может потребоваться отключить брандмауэр на хостах.
...
>> При абсолютном устаревании адреса порт удаляется по истечении указаного времени в настройках, т.е. есть ограничение по времени работы подключеного устройства к порту. 
>> При неактивности только в случае если отключеное состояние порта превысело время указаное при настройке, т.е. нет ограничение работы подключеного устройства к порту по времени 
